...
int main() {
  std::vector<std::array<double, 5>> segments;
  segments = {{1000.0, 0.0, 0.0, 0, 8},   {5000.0, 0.1, 0.0, 0, 8},
              {1000.0, 0.15, 0.0, 0, 8},  {1000.0, 0.0, 0.0, 0, 8},
              {1000.0, -0.05, 0.0, 0, 8}, {10000.0, 0.09, 0.0, 0, 8}};
