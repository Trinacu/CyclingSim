...
Course Course::from_segments(const std::vector<std::array<double, 3>> segments) {
...
double Course::get_slope(double pos) const { return segments[find_segment(pos)].slope; }
